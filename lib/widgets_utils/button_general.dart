...
class ButtonGeneral extends StatelessWidget {
  ...
  const ButtonGeneral({
    ...
    this.colorCircular = UcabdemyColors.primary,
    this.widgetLatIzq,
    this.widgetLatDer,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle textStyleLocal = textStyle ?? UcademyStyles().stylePrimary();
    ...
    return Container(
      ...
      Material(
        ...
        child: InkWell(
          splashColor: UcabdemyColors.primary.withOpacity(0.5),
          borderRadius: BorderRadius.circular(radius ?? 0),
          onTap: onPressed,
          child: Center(
            child: Padding(
